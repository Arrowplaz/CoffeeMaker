...
public class MappingController {
    ...
    /**
     * On a GET request to /specialRecipe, the RecipeController will return
      * /src/main/resources/templates/specialRecipe.html.
      * @param model
      * 				underlying UI Model
      * @return contents of the page
      */
     @GetMapping ( { "/specialRecipe", "/specialRecipe.html" } )
     public String addSpecialRecipePage ( final Model model ) {
    ...
    /**
     * On a GET request to /addInventory, the controller will return
     * /src/main/resources/templates/addInventory.html
     * @param model
     * 					underlying UI model
     * @return contents of the page
     */
